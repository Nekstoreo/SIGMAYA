...
const classes: Class[] = [
  { id: 1, name: "Matemáticas Avanzadas", code: "MAT301", schedule: "Lun, Mie 10:00-11:30", professor: "Dr. Álvarez" },
  { id: 2, name: "Programación en Python", code: "CS202", schedule: "Mar, Jue 14:00-15:30", professor: "Dra. Rodríguez" },
  { id: 3, name: "Literatura Contemporánea", code: "LIT405", schedule: "Vie 09:00-12:00", professor: "Prof. Martínez" },
]

const quickLinks = [
  { name: "Registro de cursos", icon: Book, href: "#registro-cursos" },
  { name: "Perfil del Estudiante", icon: Users, href: "#perfil-estudiante" },
  { name: "Evaluación docente", icon: ClipboardList, href: "#evaluacion-docente" },
  { name: "Solicitud de servicios", icon: Briefcase, href: "#solicitud-servicios" },
]

export default function StudentDashboard() {
  const [userRoles, setUserRoles] = useState<Array<'Estudiante' | 'Profesor' | 'Exalumno/Amigo'>>(['Estudiante', 'Profesor'])
